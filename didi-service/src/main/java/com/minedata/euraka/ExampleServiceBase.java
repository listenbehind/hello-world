...
// EurekaClient eurekaClient, DynamicPropertyFactory configInstance) {
...
//
// try {
// int myServingPort = applicationInfoManager.getInfo().getPort(); // read from my
// // registered info
...
// String vipAddress =
// configInstance.getStringProperty("eureka.vipAddress", "sampleservice.mydomain.net")
// .get();
